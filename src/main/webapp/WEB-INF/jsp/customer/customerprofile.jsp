...
<c:import url="../header.jsp">
	...
	<c:param name="title" value="Customer Profile"></c:param>
</c:import>
			...
			<div id="login-overlay" class="modal-dialog"
				...
				<div class="modal-content">
					<div class="modal-header">
						<h3 class="modal-title">${customer.firstName}'s profile</h3>
					</div>
								...
								<div class=" col-md-9 col-lg-9 table-responsive"> 
									<table class="table table-user-information table-sm">
										<tbody>
											...
											<tr class="col-xs-12">
												<td>Date of Birth</td>
												<td><fmt:formatDate value="${customer.dateOfBirth}" var="dateString" pattern="yyyy-MM-dd" />${dateString}</td>
											</tr>
											<tr class="col-xs-12">
												<td>Joined On</td>
											...
											<tr class="col-xs-12">
												<td>Phone Number</td>
												<td>${customer.phoneLandline}(Landline)<br>
												<br>${customer.phoneMobile}(Mobile)
												</td>
									...
									<a href="#" class="btn btn-primary">Report of Transportations</a>
								</div>
							</div>
						</div>
					</div>
